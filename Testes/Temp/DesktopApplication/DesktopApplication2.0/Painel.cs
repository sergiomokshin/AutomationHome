    ...
    public partial class Painel : Form
    {
        ...
        private void AtualizaInterface(string comando)
        {
            if (comando.IndexOf("|COMANDOS") == 0)
            {
                ...
                lblTipo1.Text = String.Format("{0}:00 até {1}:59", S1HrI, S1HrF);
                lblTipo2.Text = String.Format("{0}:00 até {1}:59", S2HrI, S2HrF);
                lblTipo3.Text = String.Format("{0}:00 até {1}:59", S3HrI, S3HrF);
                lblTipo4.Text = String.Format("{0}:00 até {1}:59", S4HrI, S4HrF);
                lblTipo5.Text = String.Format("{0}:00 até {1}:59", S5HrI, S5HrF);
                lblTipo6.Text = String.Format("{0}:00 até {1}:59", S6HrI, S6HrF);
                lblTipo7.Text = String.Format("{0}:00 até {1}:59", S7HrI, S7HrF);
                lblTipo8.Text = String.Format("{0}:00 até {1}:59", S8HrI, S8HrF);
            }
