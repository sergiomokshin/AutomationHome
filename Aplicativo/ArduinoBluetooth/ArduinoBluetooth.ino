...
int MemSaida1HrI = 10; //Endereço de memoria com conteudo inicio horario Saida 1
int MemSaida1HrF = 11; //Endereço de memoria com conteudo fim horario Saida 1
int MemSaida2HrI = 12; //Endereço de memoria com conteudo inicio horario Saida 2
int MemSaida2HrF = 13; //Endereço de memoria com conteudo fim horario Saida 2
int MemSaida3HrI = 14; //Endereço de memoria com conteudo inicio horario Saida 3
int MemSaida3HrF = 15; //Endereço de memoria com conteudo fim horario Saida 3
int MemSaida4HrI = 16; //Endereço de memoria com conteudo inicio horario Saida 4
int MemSaida4HrF = 17; //Endereço de memoria com conteudo fim horario Saida 4
int MemSaida5HrI = 18; //Endereço de memoria com conteudo inicio horario Saida 5
int MemSaida5HrF = 19; //Endereço de memoria com conteudo fim horario Saida 5
int MemSaida6HrI = 20; //Endereço de memoria com conteudo inicio horario Saida 6
int MemSaida6HrF = 21; //Endereço de memoria com conteudo fim horario Saida 6
int MemSaida7HrI = 22; //Endereço de memoria com conteudo inicio horario Saida 7
int MemSaida7HrF = 23; //Endereço de memoria com conteudo fim horario Saida 7
int MemSaida8HrI = 24; //Endereço de memoria com conteudo inicio horario Saida 8
int MemSaida8HrF = 25; //Endereço de memoria com conteudo fim horario Saida 8

int MemRGBHrI = 26; //Endereço de memoria com conteudo inicio horario RGB
int MemRGBHrF = 27; //Endereço de memoria com conteudo fim horario RGB
int MemRGBType = 28; //Endereço de memoria com conteudo inicio horario RGB com cor Azul
int MemRGBBLUEHrF = 29; //Endereço de memoria com conteudo fim horario RGB com cor Azul

int MemRed = 30; //Endereço de memoria com ultimo comando enviado Red
int MemGreen = 31; //Endereço de memoria com ultimo comando enviado Green
int MemBlue = 32; //Endereço de memoria com ultimo comando enviado Blue
