...
public class ApplicationPreferences {
    ...
    public String getNameSaida1() {
        return mPreferences.getString("SAIDA1", "Saída 1");
    }

    public void setNameSaida1(String value) {
        mEditor.putString("SAIDA1", value).apply();
    }

    public String getNameSaida2() {
        return mPreferences.getString("SAIDA2", "Saída 2");
    }

    public void setNameSaida2(String value) {
        mEditor.putString("SAIDA2", value).apply();
    }

    public String getNameSaida3() {
        return mPreferences.getString("SAIDA3", "Saída 3");
    }

    public void setNameSaida3(String value) {
        mEditor.putString("SAIDA3", value).apply();
    }

    public String getNameSaida4() {
        return mPreferences.getString("SAIDA4", "Saída 4");
    }

    public void setNameSaida4(String value) {
        mEditor.putString("SAIDA4", value).apply();
    }

    public String getNameSaida5() {
        return mPreferences.getString("SAIDA5", "Saída 5");
    }

    public void setNameSaida5(String value) {
        mEditor.putString("SAIDA5", value).apply();
    }

    public String getNameSaida6() {
        return mPreferences.getString("SAIDA6", "Saída 6");
    }

    public void setNameSaida6(String value) {
        mEditor.putString("SAIDA6", value).apply();
    }

    public String getNameSaida7() {
        return mPreferences.getString("SAIDA7", "Saída 7");
    }

    public void setNameSaida7(String value) {
        mEditor.putString("SAIDA7", value).apply();
    }

    public String getNameSaida8() {
        return mPreferences.getString("SAIDA8", "Saída 8");
    }

    public void setNameSaida8(String value) {
        mEditor.putString("SAIDA8", value).apply();
    }

    public String getNameSaidaRGB() {
        return mPreferences.getString("SAIDARGB", "Saída RGB");
    }

    public void setNameSaidaRGB(String value) {
        mEditor.putString("SAIDARGB", value).apply();
    }
