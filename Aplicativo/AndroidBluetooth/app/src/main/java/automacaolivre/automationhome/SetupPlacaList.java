...
//			saidaList = LoadList();
		//} else {
//			saidaList = (ArrayList<Saida>) savedInstanceState.getSerializable(KEY);
		//}
		

        //ArrayAdapter<Saida> ad = new CustomAdapter(this, R.layout.list_setup_item, saidaList);
        //ArrayAdapter<Saida> ad = new CustomAdapter(this, saidaList);
     ...
     //   m_adapter = new CustomAdapter(this, R.layout.list_setup_item, saidaList);
